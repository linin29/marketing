  ...
  cropStart: function cropStart(e) {
    ...
    if(action === 'crop'){   //新创建crop
      ...
      $cropper.append($cropBox);
         ...
         //move image
    }else if(action === 'all'){ //move cropBox
...
var methods = {
  ...
  getCropBoxData: function getCropBoxData() {
    ...
    return self.ready && self.cropped ? {
      ...
      height: cropBox.height,
      label: cropBox.label,
      annotationId: $cropBox.attr('name')
    } : {};
  },
...
var Cropper = function () {
  ...
  createClass(Cropper, [{
    ...
    value: function read(arrayBuffer) {
      //can not in by use local image file
...
$.fn.cropper = function jQueryCropper(option) {
  ...
  this.each(function (i, element) {
    ...
    $('.cropper-container').on('mouseover', '.cropper-face', function(e){
        var $cropperBox = $(this).parent();
        $cropperBox.css('z-index', 10);
    }).on('mouseout', '.cropper-face', function(e){
        var $cropperBox = $(this).parent();
        $cropperBox.css('z-index', 0);
    });
