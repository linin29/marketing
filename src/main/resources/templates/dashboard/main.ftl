...
<head>
    ...
    <script type="text/javascript" src="${springMacroRequestContext.contextPath}/js/bootstrap-datetimepicker.js" ></script>
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			if(firstMenu){
		     ...
		     var listurl = "${springMacroRequestContext.contextPath}/task";
